...
public class VagaIT {
    ...
    @Test
    public void criarVaga_ComCodigoJaExistente_RetornarErroMessageStatus409() {
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void criarVaga_ComDadosInvalidos_RetornarErroMessageStatus422() {
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .bodyValue(new VagaCreateDto("A-05", "STATUSINVALIDO"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody()
                .jsonPath("status").isEqualTo(422)
    ...
    @Test
    public void buscarVaga_ComCodigoExistente_RetornarEVagaComStatus200() {
        testClient
                .get()
    ...
    @Test
    public void criarVaga_SemPermissao_RetornarErroMessage403() {
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
