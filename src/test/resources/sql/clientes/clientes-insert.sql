...
insert into CLIENTES (id, nome, cpf, id_usuario) values (10, 'Bianca Silva', '01303455048', 101);
insert into CLIENTES (id, nome, cpf, id_usuario) values (20, 'Roberto Gomes', '97768741005', 102);
